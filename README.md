...
```php
composer create-project --prefer-dist laravel/laravel cmsv5
```
Bu kod sayesinde içinde bulunduğumuz klasör (directory) içerisine "cmsv5" klasörü oluşturarak buraya proje dosyaları ile beraber demo bir server.php dosyası oluşturuyor.
