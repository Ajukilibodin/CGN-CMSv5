...
<input  type="tel"  class="form-control"  name="cardNumber" placeholder="GEÇERLİ KREDİ KARTI NUMARASI"  autocomplete="cc-number"  required autofocus/>
...
<input  type="tel"  class="form-control"  name="cardExpiry" placeholder="AA / YY" autocomplete="cc-exp" required/>
</div>
</div>
